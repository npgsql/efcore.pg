...
namespace Microsoft.EntityFrameworkCore
{
    public static class NpgsqlPGroongaDbFunctionsExtensions
    {
        ...
        public static bool Match(this DbFunctions _, string query, string keyword) => throw new NotSupportedException();
        ...
        public static bool Query(this DbFunctions _, string query, string keyword) => throw new NotSupportedException();
        ...
        public static bool SimilarSearch(this DbFunctions _, string query, string keyword) => throw new NotSupportedException();
        ...
        public static bool ScriptQuery(this DbFunctions _, string query, string keyword) => throw new NotSupportedException();
        ...
        public static bool MatchIn(this DbFunctions _, string query, string[] keywords) => throw new NotSupportedException();
        ...
        public static bool QueryIn(this DbFunctions _, string query, string[] keywords) => throw new NotSupportedException();
        ...
        public static bool PrefixSearch(this DbFunctions _, string query, string keyword) => throw new NotSupportedException();
        ...
        public static bool PrefixRkSearch(this DbFunctions _, string query, string keyword) => throw new NotSupportedException();
        ...
        public static bool PrefixSearchIn(this DbFunctions _, string query, string[] keywords) => throw new NotSupportedException();
        ...
        public static bool PrefixRkSearchIn(this DbFunctions _, string query, string[] keywords) => throw new NotSupportedException();
        ...
        public static bool RegexpMatch(this DbFunctions _, string query, string keyword) => throw new NotSupportedException();
