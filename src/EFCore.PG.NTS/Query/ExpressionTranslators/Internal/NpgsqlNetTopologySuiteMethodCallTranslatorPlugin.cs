...
namespace Npgsql.EntityFrameworkCore.PostgreSQL.Query.ExpressionTranslators.Internal
{
    ...
    public class NpgsqlGeometryMethodTranslator : IMethodCallTranslator
    {
        ...
        public virtual SqlExpression Translate(SqlExpression instance, MethodInfo method, IReadOnlyList<SqlExpression> arguments)
        {
            ...
            nameof(NpgsqlNetTopologySuiteDbFunctionsExtensions.Transform) => _sqlExpressionFactory.Function("ST_Transform",      new[] { instance }.Concat(arguments), typeof(Geometry), resultGeometryTypeMapping),
