...
To set up the NetTopologySuite plugin, make the following modification to your `UseNpgsql()` line:
...
var nearbyCities = context.Cities.Where(c => c.Location.Distance(new Point(8,8)) < 10).ToList();
```
