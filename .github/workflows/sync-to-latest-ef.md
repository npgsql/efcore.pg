...
## 1. Find out and depend on the latest EF Core daily build

Find what the latest EF Core daily build version is, and update the EF Core version in Directory.Packages.props to use it. The EF Core daily build nuget feed is https://pkgs.dev.azure.com/dnceng/public/_packaging/dotnet11/nuget/v3/index.json (note that you may need to update dotnet11 to dotnet12 etc.).
...
Create a PR in https://github.com/npgsql/efcore.pg with all the changes. Even if you've failed to arrive at a 100% passing build, submit whatever work you did do as a basis for further manual work.
