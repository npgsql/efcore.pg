...
public class NpgsqlTypeMappingSourceTest
{
    ...
    {
        var mapping = (RelationalTypeMapping)CreateTypeMappingSource().FindMapping(clrType);
    ...
    {
        var mapping = (RelationalTypeMapping)CreateTypeMappingSource().FindMapping(typeof(char));
        var parameter = (NpgsqlParameter)mapping.CreateParameter(new NpgsqlCommand(), "p", "foo");
    ...
    {
        var mapping14 = (RelationalTypeMapping)CreateTypeMappingSource(postgresVersion: new(14, 0)).FindMapping(typeof(NpgsqlRange<int>[]))!;
        var mapping13 = (RelationalTypeMapping)CreateTypeMappingSource(postgresVersion: new(13, 0)).FindMapping(typeof(NpgsqlRange<int>[]))!;
        var mappingDefault = (RelationalTypeMapping)CreateTypeMappingSource().FindMapping(typeof(NpgsqlRange<int>[]))!;
