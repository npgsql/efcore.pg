...
public class NpgsqlTypeMappingTest
{
    ...
    {
        var mapping = new NpgsqlEnumTypeMapping("dummy_enum", "dummy_enum", typeof(DummyEnum), new NpgsqlSnakeCaseNameTranslator());
    ...
    {
        var mapping = new NpgsqlEnumTypeMapping(@"""DummyEnum""", "DummyEnum", typeof(DummyEnum), new NpgsqlSnakeCaseNameTranslator());
