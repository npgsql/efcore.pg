...
public class TPTInheritanceQueryNpgsqlTest(TPTInheritanceQueryNpgsqlFixture fixture, ITestOutputHelper testOutputHelper)
    : TPTInheritanceQueryTestBase<TPTInheritanceQueryNpgsqlFixture>(fixture, testOutputHelper)
{
...
""",
            //
            """
SELECT d."Id", d."SortIndex", l."LiltCO2", l."SugarGrams", d."ComplexTypeCollection", d."ParentComplexType_Int", d."ParentComplexType_UniqueInt", d."ParentComplexType_Nested_NestedInt", d."ParentComplexType_Nested_UniqueInt"
FROM "Drinks" AS d
...
""",
            //
            """
SELECT d."Id", d."SortIndex", t."CaffeineGrams", t."HasMilk", d."ComplexTypeCollection", d."ParentComplexType_Int", d."ParentComplexType_UniqueInt", d."ParentComplexType_Nested_NestedInt", d."ParentComplexType_Nested_UniqueInt", t."ChildComplexType_Int", t."ChildComplexType_UniqueInt", t."ChildComplexType_Nested_NestedInt", t."ChildComplexType_Nested_UniqueInt"
FROM "Drinks" AS d
...
LEFT JOIN "Birds" AS b ON a."Id" = b."Id"
LEFT JOIN "Kiwi" AS k ON a."Id" = k."Id"
WHERE k."Id" IS NOT NULL AND k."FoundOn" = 0
""");
    }
...
LEFT JOIN "Birds" AS b ON a."Id" = b."Id"
LEFT JOIN "Kiwi" AS k ON a."Id" = k."Id"
WHERE k."Id" IS NOT NULL AND k."FoundOn" = 1
""");
    }
