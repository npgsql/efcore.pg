...
public class TPHInheritanceTableSplittingQueryNpgsqlTest(
    TPHInheritanceQueryNpgsqlFixture fixture,
    ITestOutputHelper testOutputHelper)
    : TPHInheritanceTableSplittingQueryRelationalTestBase<TPHInheritanceQueryNpgsqlFixture>(fixture, testOutputHelper)
{
