...
public abstract class OwnedTableSplittingProjectionNpgsqlTest(OwnedTableSplittingNpgsqlFixture fixture, ITestOutputHelper testOutputHelper)
    : OwnedTableSplittingProjectionRelationalTestBase<OwnedTableSplittingNpgsqlFixture>(fixture, testOutputHelper)
{
...
ORDER BY r."Id" NULLS FIRST, o."RelatedTypeRootEntityId" NULLS FIRST, o."Id" NULLS FIRST, s."RootEntityId" NULLS FIRST, s."Id" NULLS FIRST, s."RelatedTypeRootEntityId" NULLS FIRST, s."RelatedTypeId" NULLS FIRST, s."Id0" NULLS FIRST, r2."RelatedTypeRootEntityId" NULLS FIRST
""");
    }
...
ORDER BY r."Id" NULLS FIRST, r0."RelatedTypeRootEntityId" NULLS FIRST
""");
        }
    }
...
LEFT JOIN "OptionalRelated_NestedCollection" AS o ON CASE
    WHEN r."OptionalRelated_Id" IS NOT NULL AND r."OptionalRelated_Int" IS NOT NULL AND r."OptionalRelated_Name" IS NOT NULL AND r."OptionalRelated_String" IS NOT NULL THEN r."Id"
END = o."RelatedTypeRootEntityId"
ORDER BY r."Id" NULLS FIRST, o."RelatedTypeRootEntityId" NULLS FIRST
""");
        }
    }
...
ORDER BY r."Id" NULLS FIRST, r0."Id" NULLS FIRST, r1."RelatedTypeRootEntityId" NULLS FIRST
""");
        }
    }
...
ORDER BY r."Id" NULLS FIRST, s."RootEntityId" NULLS FIRST, s."Id" NULLS FIRST, s."RelatedTypeRootEntityId" NULLS FIRST, s."RelatedTypeId" NULLS FIRST
""");
        }
    }
...
LEFT JOIN "RelatedCollection_NestedCollection" AS r1 ON r0."RootEntityId" = r1."RelatedTypeRootEntityId" AND r0."Id" = r1."RelatedTypeId"
ORDER BY r."Id" NULLS FIRST, r0."RootEntityId" NULLS FIRST, r0."Id" NULLS FIRST, r1."RelatedTypeRootEntityId" NULLS FIRST, r1."RelatedTypeId" NULLS FIRST
""");
        }
    }
...
FROM "RootEntity" AS r
LEFT JOIN LATERAL (
    SELECT r0."Id", r0."RequiredRelated_RequiredNested_Id", r0."RequiredRelated_RequiredNested_Int", r0."RequiredRelated_RequiredNested_Name", r0."RequiredRelated_RequiredNested_String"
...
FROM "RootEntity" AS r
LEFT JOIN LATERAL (
    SELECT r0."Id", r0."OptionalRelated_RequiredNested_Id", r0."OptionalRelated_RequiredNested_Int", r0."OptionalRelated_RequiredNested_Name", r0."OptionalRelated_RequiredNested_String"
    FROM "RootEntity" AS r0
    ORDER BY r0."Id" NULLS FIRST
    LIMIT 1
) AS r1 ON TRUE
