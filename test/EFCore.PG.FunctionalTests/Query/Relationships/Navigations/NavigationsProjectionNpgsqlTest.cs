...
public class NavigationsProjectionNpgsqlTest
    : NavigationsProjectionRelationalTestBase<NavigationsNpgsqlFixture>
{
    public NavigationsProjectionNpgsqlTest(NavigationsNpgsqlFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
