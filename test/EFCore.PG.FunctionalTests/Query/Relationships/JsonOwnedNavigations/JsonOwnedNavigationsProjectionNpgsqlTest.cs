...
public class JsonOwnedNavigationsProjectionNpgsqlTest
    : JsonOwnedNavigationsProjectionRelationalTestBase<JsonOwnedNavigationsNpgsqlFixture>
{
    public JsonOwnedNavigationsProjectionNpgsqlTest(JsonOwnedNavigationsNpgsqlFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
