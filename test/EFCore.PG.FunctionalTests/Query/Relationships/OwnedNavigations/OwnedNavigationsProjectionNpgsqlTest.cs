...
// TODO: Unskip (remove abstract) for 10.0.0-rc.2, https://github.com/dotnet/efcore/pull/36595
public abstract class OwnedNavigationsProjectionNpgsqlTest(OwnedNavigationsNpgsqlFixture fixture, ITestOutputHelper testOutputHelper)
    : OwnedNavigationsProjectionRelationalTestBase<OwnedNavigationsNpgsqlFixture>(fixture, testOutputHelper)
{
...
ORDER BY r."Id" NULLS FIRST, o."RootEntityId" NULLS FIRST, o0."RelatedTypeRootEntityId" NULLS FIRST, o1."RelatedTypeRootEntityId" NULLS FIRST, r0."RootEntityId" NULLS FIRST, r1."RelatedTypeRootEntityId" NULLS FIRST, r2."RelatedTypeRootEntityId" NULLS FIRST, o2."RelatedTypeRootEntityId" NULLS FIRST, o2."Id" NULLS FIRST, s."RootEntityId" NULLS FIRST, s."Id" NULLS FIRST, s."RelatedTypeRootEntityId" NULLS FIRST, s."RelatedTypeId" NULLS FIRST, s."RelatedTypeRootEntityId0" NULLS FIRST, s."RelatedTypeId0" NULLS FIRST, s."RelatedTypeRootEntityId1" NULLS FIRST, s."RelatedTypeId1" NULLS FIRST, s."Id0" NULLS FIRST, r7."RelatedTypeRootEntityId" NULLS FIRST
""");
    }
...
ORDER BY r."Id" NULLS FIRST, r0."RootEntityId" NULLS FIRST, r1."RelatedTypeRootEntityId" NULLS FIRST, r2."RelatedTypeRootEntityId" NULLS FIRST, r3."RelatedTypeRootEntityId" NULLS FIRST
""");
        }
    }
...
LEFT JOIN "OptionalRelated_RequiredNested" AS o1 ON o."RootEntityId" = o1."RelatedTypeRootEntityId"
LEFT JOIN "OptionalRelated_NestedCollection" AS o2 ON o."RootEntityId" = o2."RelatedTypeRootEntityId"
ORDER BY r."Id" NULLS FIRST, o."RootEntityId" NULLS FIRST, o0."RelatedTypeRootEntityId" NULLS FIRST, o1."RelatedTypeRootEntityId" NULLS FIRST, o2."RelatedTypeRootEntityId" NULLS FIRST
""");
        }
    }
...
ORDER BY r."Id" NULLS FIRST, r0."Id" NULLS FIRST, r1."RootEntityId" NULLS FIRST, r2."RelatedTypeRootEntityId" NULLS FIRST, r3."RelatedTypeRootEntityId" NULLS FIRST, r4."RelatedTypeRootEntityId" NULLS FIRST
""");
        }
    }
...
ORDER BY r."Id" NULLS FIRST, s."RootEntityId" NULLS FIRST, s."Id" NULLS FIRST, s."RelatedTypeRootEntityId" NULLS FIRST, s."RelatedTypeId" NULLS FIRST, s."RelatedTypeRootEntityId0" NULLS FIRST, s."RelatedTypeId0" NULLS FIRST, s."RelatedTypeRootEntityId1" NULLS FIRST, s."RelatedTypeId1" NULLS FIRST
""");
        }
    }
...
ORDER BY r."Id" NULLS FIRST, r0."RootEntityId" NULLS FIRST, r1."RelatedTypeRootEntityId" NULLS FIRST
""");
        }
    }
...
ORDER BY r."Id" NULLS FIRST, o."RootEntityId" NULLS FIRST, o0."RelatedTypeRootEntityId" NULLS FIRST
""");
        }
    }
...
LEFT JOIN "RelatedCollection_RequiredNested" AS r2 ON r0."RootEntityId" = r2."RelatedTypeRootEntityId" AND r0."Id" = r2."RelatedTypeId"
LEFT JOIN "RelatedCollection_NestedCollection" AS r3 ON r0."RootEntityId" = r3."RelatedTypeRootEntityId" AND r0."Id" = r3."RelatedTypeId"
ORDER BY r."Id" NULLS FIRST, r0."RootEntityId" NULLS FIRST, r0."Id" NULLS FIRST, r1."RelatedTypeRootEntityId" NULLS FIRST, r1."RelatedTypeId" NULLS FIRST, r2."RelatedTypeRootEntityId" NULLS FIRST, r2."RelatedTypeId" NULLS FIRST, r3."RelatedTypeRootEntityId" NULLS FIRST, r3."RelatedTypeId" NULLS FIRST
""");
        }
    }
...
FROM "RootEntity" AS r
LEFT JOIN LATERAL (
    SELECT r2."RelatedTypeRootEntityId", r2."Id", r2."Int", r2."Name", r2."String"
