...
public abstract class OwnedNavigationsCollectionNpgsqlTest(OwnedNavigationsNpgsqlFixture fixture, ITestOutputHelper testOutputHelper)
    : OwnedNavigationsCollectionRelationalTestBase<OwnedNavigationsNpgsqlFixture>(fixture, testOutputHelper)
{
...
ORDER BY r."Id" NULLS FIRST, o."RootEntityId" NULLS FIRST, o0."RelatedTypeRootEntityId" NULLS FIRST, o1."RelatedTypeRootEntityId" NULLS FIRST, r1."RootEntityId" NULLS FIRST, r2."RelatedTypeRootEntityId" NULLS FIRST, r3."RelatedTypeRootEntityId" NULLS FIRST, o2."RelatedTypeRootEntityId" NULLS FIRST, o2."Id" NULLS FIRST, s."RootEntityId" NULLS FIRST, s."Id" NULLS FIRST, s."RelatedTypeRootEntityId" NULLS FIRST, s."RelatedTypeId" NULLS FIRST, s."RelatedTypeRootEntityId0" NULLS FIRST, s."RelatedTypeId0" NULLS FIRST, s."RelatedTypeRootEntityId1" NULLS FIRST, s."RelatedTypeId1" NULLS FIRST, s."Id0" NULLS FIRST, r8."RelatedTypeRootEntityId" NULLS FIRST
""");
    }
...
SELECT (
    SELECT COALESCE(sum((
        ...
        WHERE r0."RootEntityId" = r1."RelatedTypeRootEntityId" AND r0."Id" = r1."RelatedTypeId")), 0)::int
    FROM "RelatedCollection" AS r0
    WHERE r."Id" = r0."RootEntityId")
FROM "RootEntity" AS r
""");
