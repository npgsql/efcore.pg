...
public class NavigationsCollectionNpgsqlTest(NavigationsNpgsqlFixture fixture, ITestOutputHelper testOutputHelper)
    : NavigationsCollectionRelationalTestBase<NavigationsNpgsqlFixture>(fixture, testOutputHelper)
{
...
ORDER BY r."Id" NULLS FIRST, r2."Id" NULLS FIRST, n."Id" NULLS FIRST, n0."Id" NULLS FIRST, r3."Id" NULLS FIRST, n1."Id" NULLS FIRST, n2."Id" NULLS FIRST, n3."Id" NULLS FIRST, s."Id" NULLS FIRST, s."Id0" NULLS FIRST, s."Id1" NULLS FIRST, s."Id2" NULLS FIRST
""");
    }
...
SELECT (
    SELECT COALESCE(sum((
        ...
        WHERE r0."Id" = n."CollectionRelatedId")), 0)::int
    FROM "RelatedType" AS r0
    WHERE r."Id" = r0."CollectionRootId")
FROM "RootEntity" AS r
""");
