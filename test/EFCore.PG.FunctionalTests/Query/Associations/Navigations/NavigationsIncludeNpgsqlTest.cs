...
public class NavigationsIncludeNpgsqlTest(NavigationsNpgsqlFixture fixture, ITestOutputHelper testOutputHelper)
    : NavigationsIncludeRelationalTestBase<NavigationsNpgsqlFixture>(fixture, testOutputHelper)
{
