...
WHERE (
    ...
    FROM (
        ...
        WHERE r."Id" = r1."CollectionRootId" AND r1."String" = 'foo'
    ) AS u) = 4
...
SELECT (
    SELECT COALESCE(sum((
        ...
        WHERE u."Id" = n."CollectionRelatedId")), 0)::int
    FROM (
        SELECT r0."Id"
        FROM "RelatedType" AS r0
        WHERE r."Id" = r0."CollectionRootId" AND r0."Int" = 8
...
WHERE (
    ...
    FROM (
        ...
        WHERE r0."Id" = n0."CollectionRelatedId" AND n0."String" = 'foo'
    ) AS u) = 4
ORDER BY r."Id" NULLS FIRST, r0."Id" NULLS FIRST, r1."Id" NULLS FIRST, n1."Id" NULLS FIRST, n2."Id" NULLS FIRST, n3."Id" NULLS FIRST, n4."Id" NULLS FIRST, n5."Id" NULLS FIRST, s."Id" NULLS FIRST, s."Id0" NULLS FIRST, s."Id1" NULLS FIRST, s."Id2" NULLS FIRST
""");
    }
