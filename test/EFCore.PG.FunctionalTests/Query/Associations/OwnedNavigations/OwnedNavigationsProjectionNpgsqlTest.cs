...
public class OwnedNavigationsProjectionNpgsqlTest(OwnedNavigationsNpgsqlFixture fixture, ITestOutputHelper testOutputHelper)
...
FROM "RootEntity" AS r
LEFT JOIN LATERAL (
    SELECT r2."RelatedTypeRootEntityId", r2."Id", r2."Int", r2."Ints", r2."Name", r2."String"
