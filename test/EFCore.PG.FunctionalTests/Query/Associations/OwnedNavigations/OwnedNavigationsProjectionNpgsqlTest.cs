...
ORDER BY r."Id" NULLS FIRST, r0."RootEntityId" NULLS FIRST, r1."AssociateTypeRootEntityId" NULLS FIRST, r2."AssociateTypeRootEntityId" NULLS FIRST, r3."AssociateTypeRootEntityId" NULLS FIRST, r3."Id" NULLS FIRST, r4."AssociateTypeRootEntityId" NULLS FIRST
""");
        }
    }
...
LEFT JOIN "RequiredRelated" AS r0 ON r."Id" = r0."RootEntityId"
LEFT JOIN "OptionalRelated_NestedCollection" AS o2 ON o."RootEntityId" = o2."AssociateTypeRootEntityId"
ORDER BY r."Id" NULLS FIRST, o."RootEntityId" NULLS FIRST, o0."AssociateTypeRootEntityId" NULLS FIRST, o1."AssociateTypeRootEntityId" NULLS FIRST, r0."RootEntityId" NULLS FIRST, o2."AssociateTypeRootEntityId" NULLS FIRST
""");
        }
    }
