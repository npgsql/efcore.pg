...
public class BitwiseOperatorTranslationsNpgsqlTest : BitwiseOperatorTranslationsTestBase<BasicTypesQueryNpgsqlFixture>
{
    public BitwiseOperatorTranslationsNpgsqlTest(BasicTypesQueryNpgsqlFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
