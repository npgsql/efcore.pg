...
public class ComparisonOperatorTranslationsNpgsqlTest : ComparisonOperatorTranslationsTestBase<BasicTypesQueryNpgsqlFixture>
{
    public ComparisonOperatorTranslationsNpgsqlTest(BasicTypesQueryNpgsqlFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
