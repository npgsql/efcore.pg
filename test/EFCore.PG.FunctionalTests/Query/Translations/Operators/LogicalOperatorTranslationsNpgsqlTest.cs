...
public class LogicalOperatorTranslationsNpgsqlTest : LogicalOperatorTranslationsTestBase<BasicTypesQueryNpgsqlFixture>
{
    public LogicalOperatorTranslationsNpgsqlTest(BasicTypesQueryNpgsqlFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
