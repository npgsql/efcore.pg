...
public class ArithmeticOperatorTranslationsNpgsqlTest : ArithmeticOperatorTranslationsTestBase<BasicTypesQueryNpgsqlFixture>
{
    public ArithmeticOperatorTranslationsNpgsqlTest(BasicTypesQueryNpgsqlFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
