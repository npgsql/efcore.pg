...
public class EntitySplittingQueryNpgsqlTest : EntitySplittingQueryTestBase<EntitySplittingQueryNpgsqlTest.EntitySplittingQueryNpgsqlFixture>
{
    public EntitySplittingQueryNpgsqlTest(EntitySplittingQueryNpgsqlFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
FROM ""SplitEntityOneMain"" AS s");
    ...
    public class EntitySplittingQueryNpgsqlFixture : EntitySplittingQueryFixtureBase
    {
