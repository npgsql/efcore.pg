...
public class NpgsqlDoubleTypeTest(NpgsqlDoubleTypeTest.DoubleTypeFixture fixture, ITestOutputHelper testOutputHelper)
    : RelationalTypeTestBase<double, NpgsqlDoubleTypeTest.DoubleTypeFixture>(fixture, testOutputHelper)
{
...
WHERE (CAST(j."JsonContainer" ->> 'Value' AS double precision)) = @Fixture_Value
LIMIT 2
""");
    }
...
""");
    ...
    public class DoubleTypeFixture : NpgsqlTypeFixture<double>
    {
