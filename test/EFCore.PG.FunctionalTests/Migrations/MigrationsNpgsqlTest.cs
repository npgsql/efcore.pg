...
""");
    ...
    [ConditionalFact, MinimumPostgresVersion(15, 0)]
...
""");
    ...
    public virtual async Task Create_table_with_primary_key_without_overlaps()
    {
        await Test(
            _ => { },
            builder => builder.Entity(
                ...
                {
                    e.Property<int>("Id");
                    e.Property<NpgsqlRange<DateTime>>("During");
            ...
            model =>
            {
                ...
                Assert.Equal(true, table.PrimaryKey[NpgsqlAnnotationNames.WithoutOverlaps]);
            });
...
CREATE TABLE "Reservations" (
    ...
    CONSTRAINT "PK_Reservations" PRIMARY KEY ("Id", "During" WITHOUT OVERLAPS)
);
""");
    }

    [ConditionalFact, MinimumPostgresVersion(18, 0)]
    public virtual async Task Create_table_with_alternate_key_without_overlaps()
    {
        await Test(
            _ => { },
            builder => builder.Entity(
                ...
                {
                    e.Property<int>("Id");
                    e.Property<int>("RoomId");
                    e.Property<NpgsqlRange<DateTime>>("During");
                    e.HasKey("Id");
                    e.HasAlternateKey("RoomId", "During").WithoutOverlaps();
                }),
            model =>
            {
                var table = Assert.Single(model.Tables);
                var uniqueConstraint = Assert.Single(table.UniqueConstraints);
                Assert.Equal(true, uniqueConstraint[NpgsqlAnnotationNames.WithoutOverlaps]);
            });
...
CREATE TABLE "Reservations" (
    ...
    CONSTRAINT "AK_Reservations_RoomId_During" UNIQUE ("RoomId", "During" WITHOUT OVERLAPS)
);
""");
    }

    [ConditionalFact, MinimumPostgresVersion(18, 0)]
    public virtual async Task Alter_alternative_key_add_without_overlaps()
    {
        await Test(
            builder => builder.Entity(
                "Reservations", e =>
                {
                    ...
                    e.Property<NpgsqlRange<DateTime>>("During");
                    e.HasKey("Id");
                    e.HasAlternateKey("RoomId", "During");
                }),
            _ => { },
            builder => builder.Entity(
                "Reservations", e =>
        ...
        AssertSql(
            """ALTER TABLE "Reservations" DROP CONSTRAINT "AK_Reservations_RoomId_During";""",
            //
            """CREATE EXTENSION IF NOT EXISTS btree_gist CASCADE;""",
            //
            """ALTER TABLE "Reservations" ADD CONSTRAINT "AK_Reservations_RoomId_During" UNIQUE ("RoomId", "During" WITHOUT OVERLAPS);""");
    }

    [ConditionalFact, MinimumPostgresVersion(18, 0)]
    public virtual async Task Alter_unique_constraint_remove_without_overlaps()
    {
        await Test(
            builder => builder.Entity(
                "Reservations", e =>
            ...
            _ => { },
            builder => builder.Entity("Reservations", e => e.HasAlternateKey("RoomId", "During").WithoutOverlaps(false)),
            model =>
            {
                var table = Assert.Single(model.Tables);
                var uniqueConstraint = Assert.Single(table.UniqueConstraints);
                Assert.Null(uniqueConstraint[NpgsqlAnnotationNames.WithoutOverlaps]);
            });
...
""");
    ...
    [ConditionalFact, MinimumPostgresVersion(12, 0)]
