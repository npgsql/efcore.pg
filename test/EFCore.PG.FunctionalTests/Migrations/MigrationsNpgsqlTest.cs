...
""");
    ...
    [Fact]
    public virtual async Task Create_table_with_oid_column_when_pg_lower_than_12()
    {
        if (TestEnvironment.PostgresVersion.IsUnder(12))
        {
            await Test(
    ...
    [Fact]
    public virtual async Task Create_table_with_oid_column_when_pg_at_least_12()
    {
        if (TestEnvironment.PostgresVersion.AtLeast(12))
        {
            await Test(
                _ => { },
                builder => builder.Entity(
