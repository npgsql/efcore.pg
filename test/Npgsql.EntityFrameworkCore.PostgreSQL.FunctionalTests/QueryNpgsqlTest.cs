...
FROM ""Orders"" AS ""o""",
        ...
        public override void Sum_with_arg_expression()
        {
            ...
            Assert.Equal(
                 @"SELECT SUM(""o"".""OrderID"" + ""o"".""OrderID"")::INT4
FROM ""Orders"" AS ""o""",
                 Sql);
        }
...
SELECT ""c"".""CustomerID""
FROM ""Customers"" AS ""c""
WHERE ((""c"".""CustomerID"" || CAST(@__i_0 AS text))) = ""c"".""CompanyName""",
                Sql);
        }
...
SELECT ""c"".""CustomerID""
FROM ""Customers"" AS ""c""
WHERE ((CAST(@__i_0 AS text) || ""c"".""CustomerID"")) = ""c"".""CompanyName""",
                Sql);
        }
...
WHERE TRUNC(""od"".""UnitPrice"") > 10",
        ...
        public override void Where_guid_newguid()
        {
            ...
            // TODO: PostgreSQL can do GUID/UUID generation, but this requires loading extensions.
            // In theory we could allow the user to request PostgreSQL GUID/UUID generation via a context
            // annotation, but right now GUID/UUID is done client-side only
            Assert.Equal(
                @"SELECT ""od"".""OrderID"", ""od"".""ProductID"", ""od"".""Discount"", ""od"".""Quantity"", ""od"".""UnitPrice""
FROM ""Order Details"" AS ""od""",
                Sql);
        ...
        public override void Where_functions_nested()
        {
            ...
            Assert.Equal(
                @"SELECT ""c"".""CustomerID"", ""c"".""Address"", ""c"".""City"", ""c"".""CompanyName"", ""c"".""ContactName"", ""c"".""ContactTitle"", ""c"".""Country"", ""c"".""Fax"", ""c"".""Phone"", ""c"".""PostalCode"", ""c"".""Region""
FROM ""Customers"" AS ""c""
WHERE POWER(LENGTH(""c"".""CustomerID""), 2E0) = 25E0",
                Sql);
        }
...
INNER JOIN ""Orders"" AS ""o0"" ON ""o"".""CustomerID"" = ""o0"".""CustomerID""",
        ...
        public override void Where_chain()
        {
            ...
            Assert.Equal(
                @"SELECT ""o"".""OrderID"", ""o"".""CustomerID"", ""o"".""EmployeeID"", ""o"".""OrderDate""
FROM ""Orders"" AS ""o""
WHERE (""o"".""CustomerID"" = 'QUICK') AND (""o"".""OrderDate"" > '1998-01-01 00:00:00.0000000')",
                Sql);
        }
